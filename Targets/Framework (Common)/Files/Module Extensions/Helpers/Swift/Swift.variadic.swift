...
public func variadic<T, U>(_ f: (([T]) -> U)) -> ((T...) -> U)
{
    return -*>f
}

public func variadic<T, U, V>(_ f: ((T, [U]) -> V)) -> ((T, U...) -> V)
{
    return -*>f
}

public func variadic<T, U, V, W>(_ f: ((T, U, [V]) -> W)) -> ((T, U, V...) -> W)
{
    return -*>f
}
...
public func isovariadic<T, U>(_ f: ((T...) -> U)) -> (([T]) -> U)
{
    return -*>f
}

public func isovariadic<T, U, V>(_ f: ((T, U...) -> V)) -> ((T, [U]) -> V)
{
    return -*>f
}

public func isovariadic<T, U, V, W>(_ f: ((T, U, V...) -> W)) -> ((T, U, [V]) -> W)
{
    return -*>f
}

public func isovariadic<T, U, V, W, X>(_ f: ((T, U, V, W...) -> X)) -> ((T, U, V, [W]) -> X)
{
    return -*>f
}

public func isovariadic<T, U, V, W, X, Y>(_ f: ((T, U, V, W, X...) -> Y)) -> ((T, U, V, W, [X]) -> Y)
{
    return -*>f
}

public func isovariadic<T, U, V, W, X, Y, Z>(_ f: ((T, U, V, W, X, Y...) -> Z)) -> ((T, U, V, W, X, [Y]) -> Z)
{
    return -*>f
}

public func isovariadic<T, U, V>(_ f: ((inout T) -> ((U...) -> V))) -> ((inout T) -> (([U]) -> V))
{
    return -*>f
}
